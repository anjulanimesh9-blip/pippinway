      ...
      <div className="w-full max-w-md rounded-3xl border border-[#FBB03B]/30 bg-[#111827] p-6 text-center shadow-2xl">
        ...
        <div className="mt-6 flex flex-col gap-3">
          <button
            type="button"
            onClick={onContinue}
            className="min-h-14 w-full rounded-xl bg-[#FBB03B] px-4 py-3 text-base font-extrabold text-black hover:bg-[#ffc14d]"
          >
            Continue
          </button>
          <button
            ...
            className="min-h-14 w-full rounded-xl border border-white/15 bg-white/5 px-4 py-3 text-base font-bold text-white hover:bg-white/10"
          >
