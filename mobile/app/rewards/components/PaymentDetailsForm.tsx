...
const fieldClass =
  "mt-1 min-h-12 w-full rounded-xl bg-[#020817] px-3 py-3 text-base text-white outline-none";
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-3" autoComplete="off">
        ...
        <>
          ...
          <label className="block text-xs font-semibold text-gray-400">
            ...
            <textarea
              ...
              rows={3}
              className="mt-1 w-full rounded-xl bg-[#020817] px-3 py-3 text-base text-white outline-none"
            />
          </label>
        </>
      )}
      ...
      <button
        type="submit"
        disabled={submitting}
        className="min-h-14 w-full rounded-xl bg-[#FBB03B] px-4 py-3 text-base font-extrabold text-black hover:bg-[#ffc14d] disabled:opacity-60"
      >
