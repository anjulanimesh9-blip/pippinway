    ...
    <div className="space-y-6">
      ...
      <section className="pw-signals-card rounded-[28px] px-5 py-8 sm:px-8">
        ...
        <p className="mt-4 max-w-xl text-sm leading-6 text-slate-300">
          Free members get up to four unique complete-signal reveals each UTC day. Pro unlocks the Top 100 pattern scanner, charts, patterns and history. Marketplace and Vibe stay on the same login.
        </p>
