...
const NAV_ITEMS = [
  ...
  { href: "/admin/featured-payments", label: "Featured Payments", icon: CreditCard },
  { href: "/admin/rewards", label: "Rewards", icon: Gift },
  { href: "/admin/featured-packages", label: "Featured Packages", icon: Star },
  { href: "/admin/payment-settings", label: "Payment Details", icon: Landmark },
