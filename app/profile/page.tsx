...
const greeting =
  ...
  return (
    <div className="min-h-screen bg-[#020817] text-white flex">
      ...
      {/* Sidebar */}
      <div
        className={`fixed md:relative inset-y-0 left-0 z-50 h-screen w-72 bg-[#0f172a] border-r border-gray-800 p-6 transition-transform duration-300 ${menuOpen
          ? "translate-x-0"
  ...
  <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-full bg-blue-600 flex items-center justify-center text-2xl md:text-4xl font-bold">
...
<h1 className="text-xl sm:text-2xl md:text-3xl font-bold">
  {greeting}, {user?.email?.split("@")[0]} 👋
            ...
            <div
              className={`px-4 py-2 rounded-full border flex items-center gap-2 text-sm font-semibold shadow-lg ${userData?.membership ===
                "pro"
            ...
            >
              ...
              <div
                className={`px-4 py-2 rounded-full border flex items-center gap-2 text-sm font-semibold shadow-lg ${userData?.membership === "pro"
                  ? "bg-yellow-500/10 border-yellow-500 text-yellow-400"
                  : "bg-blue-500/10 border-blue-500 text-white"
                  }`}
              >
                <div
                  className={`w-2.5 h-2.5 rounded-full ${userData?.membership === "pro"
                    ? "bg-yellow-400"
                    : "bg-green-400"
                    }`}
                />
                  ...
                  {chatRooms.map(
                    (chat: any) => (
                      <div
                        ...
                        className={`p-4 border-b border-white/10 cursor-pointer transition ${selectedChat?.id ===
                          chat.id
                          ? "bg-blue-600/20"
                          : "hover:bg-[#1a2235]"
                          }`}
                  ...
                  <div className="flex-1 overflow-y-auto p-5 space-y-4">
                    ...
                    {!selectedChat ? (
                      ...
                      chatMessages.map((msg) => (
                        <div
                          key={msg.id}
                          className={`flex ${msg.sender === user?.email
                            ? "justify-end"
                            : "justify-start"
                            }`}
                        >
                          <div
                            className={`max-w-[75%] px-5 py-3 rounded-[22px] shadow-lg ${msg.sender === user?.email
        ...
        <div className="grid grid-cols-2 xl:grid-cols-4 gap-5 mb-8">
          ...
          <div className="bg-[#0f172a] rounded-[22px] border border-gray-800 p-6 shadow-xl">
            ...
            <h2 className="text-2xl md:text-2xl md:text-2xl md:text-2xl md:text-2xl md:text-4xl font-bold mt-3">
              {myAds.length}
            </h2>
          </div>
          ...
          <div className="bg-[#0f172a] rounded-[22px] border border-gray-800 p-6 shadow-xl">
            ...
            <h2 className="text-2xl md:text-2xl md:text-2xl md:text-4xl font-bold mt-3">
              {favoriteAds.length}
            </h2>
          </div>
        ...
        <div className="bg-[#0f172a] border border-gray-800 rounded-[28px] p-5 shadow-xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">    {myAds.map((ad) => (
            <div
              key={ad.id}
