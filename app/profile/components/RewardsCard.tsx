...
export default function RewardsCard({ userId }: RewardsCardProps) {
  ...
  return (
    <section className="rounded-xl border border-[#FBB03B]/25 bg-[#151A22] px-3 py-3 sm:px-4 sm:py-4">
      ...
      {loading ? (
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="rounded-lg border border-white/8 bg-[#0B0E14] px-3 py-2">
          ...
          {spinReady && (
            <Link
              href="/rewards"
              className="inline-flex w-full items-center justify-center rounded-xl bg-[#FBB03B] px-4 py-2.5 text-sm font-extrabold text-black transition hover:bg-[#ffc14d]"
            >
              SPIN NOW
            </Link>
          )}
