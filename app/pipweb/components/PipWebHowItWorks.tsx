...
export default function PipWebHowItWorks() {
  return (
    ...
    >
      <div className="mx-auto max-w-6xl px-5 py-10 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
        ...
        <ol className="relative mt-8 grid grid-cols-1 gap-3 sm:mt-12 sm:grid-cols-2 sm:gap-4 lg:grid-cols-5 lg:gap-5">
          <span
            aria-hidden
          ...
          {STEPS.map((step, index) => (
            <li key={step.title} className="relative">
              <div className="flex h-full flex-col rounded-2xl border border-white/10 bg-[#0F172A] p-4 transition duration-200 hover:-translate-y-0.5 hover:border-[#3B82F6]/40 hover:bg-[#132038] lg:items-center lg:px-4 lg:py-6 lg:text-center">
