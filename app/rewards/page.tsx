  ...
  return (
    <main className="min-h-screen bg-[#020817] text-white">
      ...
      <div className="mx-auto max-w-6xl px-4 py-8">
          ...
          <div className="mb-6 space-y-4">
            {cashBanners.map((item) => (
              <div
                ...
                className="rounded-2xl border border-[#FBB03B]/30 bg-[#FBB03B]/10 p-4 sm:p-5"
              >
        ...
        <div className="grid items-start gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(280px,420px)]">
          ...
          <div className="order-1 flex justify-center px-2 pb-2 lg:sticky lg:top-24 lg:order-2">
            <PrizeWheel
              segments={segments}
              rotation={rotation}
              spinning={spinning}
